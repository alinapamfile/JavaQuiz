...
public class NinthQuestion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ninth_activity);
    ...
    public void onClick(View view) {
        RadioButton radioButton1 = findViewById(R.id.question9_option1_radiobutton);
        RadioButton radioButton2 = findViewById(R.id.question9_option2_radiobutton);
        RadioButton radioButton3 = findViewById(R.id.question9_option3_radiobutton);
        RadioButton radioButton4 = findViewById(R.id.question9_option4_radiobutton);
        ...
        */
        if (radioButton1.isChecked() || radioButton2.isChecked() || radioButton3.isChecked() || radioButton4.isChecked()) {
            Intent intent = new Intent(this, TenthQuestion.class);
