...
public class FifthQuestion extends AppCompatActivity {
    ...
    public void onClick(View view) {
        RadioButton radioButton1 = findViewById(R.id.question5_option1_radiobutton);
        RadioButton radioButton2 = findViewById(R.id.question5_option2_radiobutton);
        RadioButton radioButton3 = findViewById(R.id.question5_option3_radiobutton);
        RadioButton radioButton4 = findViewById(R.id.question5_option4_radiobutton);
