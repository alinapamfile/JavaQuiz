...
public class EighthQuestion extends AppCompatActivity {
    ...
    public void onClick(View view) {
        RadioButton radioButton1 = findViewById(R.id.question8_option1_radiobutton);
        RadioButton radioButton2 = findViewById(R.id.question8_option2_radiobutton);
        RadioButton radioButton3 = findViewById(R.id.question8_option3_radiobutton);
        RadioButton radioButton4 = findViewById(R.id.question8_option4_radiobutton);
        ...
        */
        if (radioButton1.isChecked() || radioButton2.isChecked() || radioButton3.isChecked() || radioButton4.isChecked()) {
            Intent intent = new Intent(this, NinthQuestion.class);
