...
public class SixthQuestion extends AppCompatActivity {
    ...
    public void onClick(View view) {
        RadioButton radioButton1 = findViewById(R.id.question6_option1_radiobutton);
        RadioButton radioButton2 = findViewById(R.id.question6_option2_radiobutton);
        RadioButton radioButton3 = findViewById(R.id.question6_option3_radiobutton);
        RadioButton radioButton4 = findViewById(R.id.question6_option4_radiobutton);
